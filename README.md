...
# Results 
* The website should run and be able to save notes and display them on the left side of the screen. If the delilte button is pressed, note should be deleted. mmmmmmmmm

# Submission 
* The URL of the GitHub repository

# Tests 
* add note mmmmmmmmmmmmmm
* delete note 
* see list of notes
* going to /from pages  
